...
uint32_t si5351bx_vcoa = (SI5351BX_XTAL * SI5351BX_MSA);  // 25 mhz crystal calibrate
...
void si5351_set_calibration(int32_t cal) {
  si5351bx_vcoa = (SI5351BX_XTAL * SI5351BX_MSA) + cal;
...
void initOscillators() {
  si5351bx_init();
  si5351bx_vcoa = (SI5351BX_XTAL * SI5351BX_MSA) + calibration; // apply calibration correction factor
  si5351bx_setfreq(0, usbCarrier);
}
