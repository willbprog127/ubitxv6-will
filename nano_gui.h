...
void displayRect(unsigned int x, unsigned int y, unsigned int w, unsigned int h, unsigned int hicolor, unsigned int lowcolor = 0);
...
void displayRawText(const char * text, int x1, int y1, int color, int background);
...
const uint8_t font2_14pt7bBitmaps[] PROGMEM = {
...
const GFXglyph font2_14pt7bGlyphs[] PROGMEM = {
  {     0,   1,   1,   8,    0,    0 },   // 0x20 ' '
  {     1,   3,  20,   9,    3,  -19 },   // 0x21 '!'
  {     9,   6,   7,   9,    1,  -18 },   // 0x22 '"'
...
const GFXfont ubitx_font PROGMEM = {
  (uint8_t  *)font2_14pt7bBitmaps,
  (GFXglyph *)font2_14pt7bGlyphs,
  0x20, 0x7E, 33 };
