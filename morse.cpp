...
/*
 ######################################################
 ## All of this has been disabled because the other
 ## parts of it were already disabled from the factory
 ######################################################
*/
...
//static void morseLetter(char c) {
  ...
  //for (uint16_t i = 0; i < sizeof(morse_table) / sizeof(struct Morse); i++) {  // <<<--- was int
    //struct Morse m;
